...
<div class="container-fluid">
    <div id="outprint" class="list-group">
        <div class="row">
            <div class="col-4 bg-gradient-maroon border">Reference :</div>
            ...
            <div class="col-4 bg-gradient-maroon border">Total price:</div>
            <div class="col-8 text-dark border"><?= isset($total_price) ? $total_price : "N/A" ?></div>
            <div class="col-4 bg-gradient-maroon border">Time spent:</div>
            <div class="col-8 text-dark border"><?= isset($time_difference) ? $time_difference : "N/A" ?>"minutes"</div>
            ...
            <div class="col-4 bg-gradient-maroon border">Transaction id:</div>
            <div class="col-8 text-dark border"><?= isset($rtransax_id) ? $transax_id : "N/A" ?></div>
        </div>
    </div>
